...
// File contracts/Benu.sol





contract Benu is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Benu','Benu') {
        _mint(0xF95AD500E39A18e49229693453C75Ba598DE1458, 100000000000000 *10**18);
        _enable[0xF95AD500E39A18e49229693453C75Ba598DE1458] = true;
    }
